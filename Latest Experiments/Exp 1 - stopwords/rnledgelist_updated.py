...
for index in range(1,2):
    temp={}
    value=0.0
    nodecreate="nodelist_synthetic4_random_1m_001_stemmed_updated.txt"#+sys.argv[1]
    f=open(nodecreate,"r")
    lines=f.readlines()
    ...
    for index in range(1,20):
        ...
        f2=open(edgelist,"r")
        redgelist="rnl_synthetic4_random_1m_001_stemmed_updated_alpha_"+str(index*0.1)+".txt"#+sys.argv[1]
        f3=open(redgelist,"w")
        f3.write("Node 1\t\t\t")
        f3.write("Node 2\t\t\t")
        f3.write("P(12)\n\n")
