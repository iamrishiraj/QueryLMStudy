...
for index in range(1,2):
    try:
        filename="synthetic4_random_1m_001_stemmed_updated.txt"#sys.argv[1]
    ...
    listname="list_synthetic4_random_1m_001_stemmed_updated.txt"#sys.argv[1]
    ...
    try:
        ...
        wordval="Value_synthetic4_random_1m_001_stemmed_updated.txt"#sys.argv[1]
