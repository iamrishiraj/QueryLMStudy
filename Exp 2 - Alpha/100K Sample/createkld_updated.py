...
for index in range(1,20):
    ...
    artificiallist=[]
    inputname2="degree_dist_2_synthetic4_random_1m_001_stemmed_alpha_"+str(index*0.1)+".txt"
    ...
    outputfile=open("KL_Distribution_2_synthetic4_random_1m_001_stemmed_alpha_"+str(index*0.1)+".txt","a")
    value=0
