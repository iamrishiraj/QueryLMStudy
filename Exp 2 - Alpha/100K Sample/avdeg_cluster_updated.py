...
for index in range(0,20):
    g=nx.Graph()
    edge=[]
    redgelist="rnl_synthetic4_random_0.1m_001_stemmed_alpha_"+str(index*0.1)+".txt"
    ...
    lcc="lcc_synthetic4_random_0.1m_001_stemmed_alpha_"+str(index*0.1)+".txt"
    lccfile=open(lcc,"w")
    ...
    for u,v in h.edges():
        ...
        lccfile.write("\n")
    lccfile.close()
    prop="avgdeg_synthetic4_random_0.1m_001_stemmed_alpha_"+str(index*0.1)+".txt"
