...
for index in range(1,2):
    ...
    artificiallist=[]
    inputname2="degree_dist_2_synthetic4_random_1m_001_stemmed_alpha_0.0.txt"
    ...
    outputfile=open("KL_Distribution_2_synthetic4_random_1m_001_stemmed_alpha_0.0.txt","a")
    value=0
