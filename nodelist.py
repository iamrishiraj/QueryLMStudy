...
for index in range(1,2):
    ...
    try:
        #segval=sys.argv[1]+"_random_1m_valued_"+str(index)+".txt"
        segval=sys.argv[1]+"_random_0.1m_valued_"+str(index)+".txt"
    ...
    try:
        #listname=sys.argv[1]+"_1m_list_for_"+str(index)+".txt"
        listname=sys.argv[1]+"_0.1m_list_for_"+str(index)+".txt"
