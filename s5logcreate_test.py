...
filename=open("localtrigram.txt","r")
...
for index1 in range(1,101):
    if index1<10:
        outputname="synthetic5_random_1m_00"+str(index1)+".txt"
    elif index1<100:
        outputname="synthetic5_random_1m_0"+str(index1)+".txt"
    else:
        outputname="synthetic5_random_1m_"+str(index1)+".txt"
